    ...
    const updateGoogleButtonWidth = () => {
      ...
      setGoogleButtonWidth(
        Math.max(
          ...
          Math.min(GOOGLE_BUTTON_MAX_WIDTH, Math.floor(availableWidth)),
        ),
      );
    };
  ...
  return (
    <div className="w-full max-w-[27rem]">
      ...
      <div className="mb-5">
        {googleClientId ? (
          <>
            <div className="relative h-11 w-full overflow-hidden rounded-xl border border-slate-700/90 bg-slate-50 shadow-sm transition-colors hover:bg-white">
              <div className="pointer-events-none absolute inset-0 flex items-center justify-center gap-3 px-4 text-sm font-semibold text-slate-900">
